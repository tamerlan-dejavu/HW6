...
public class AttackCommand implements ActionCommand {
    ...
    public void execute() {
        ...
        System.out.println("Dealt " + damageDealt + " damage to " + target.getName() + ". Opponent HP: " + target.getHealth());
    }

    @Override
    public void undo() {
        target.restoreHealth(damageDealt);
        System.out.println("Restored " + damageDealt + " HP to " + target.getName());
    }
